...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-x-0 bottom-0 z-[102] mt-24 flex h-auto flex-col rounded-t-[20px] border border-border bg-white",
        className,
      )}
      {...props}
    >
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Title
    ref={ref}
    className={cn(
      "m-display text-xl tracking-tightest leading-none",
      className,
    )}
    {...props}
  />
